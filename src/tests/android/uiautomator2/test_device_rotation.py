...
def test_device_rotation(appium_service, android_driver_factory):
    ...
    with android_driver_factory(custom_opts) as driver:
        ...
        print(orientation)
        assert_that(orientation).is_equal_to('PORTRAIT')

        driver.orientation = 'LANDSCAPE'
        orientation = driver.orientation
        assert_that(orientation).is_equal_to('LANDSCAPE')
